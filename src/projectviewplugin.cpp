...
K_PLUGIN_FACTORY(KCScopeFactory, registerPlugin<ProjectViewPlugin>(); )
...
ProjectViewPlugin::ProjectViewPlugin(QObject* parent, const QVariantList&):KDevelop::IPlugin(KCScopeFactory::componentData(), parent)
{
